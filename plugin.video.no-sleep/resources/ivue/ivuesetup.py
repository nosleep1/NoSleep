...
ini          =  xbmc.translatePath(os.path.join('special://home/addons/plugin.video.no-sleep/resources/ivue','no-sleep.ini'))
inizip       = 	xbmc.translatePath(os.path.join('special://home/addons/plugin.video.no-sleep/resources/ivue','plugin.video.no-sleep.zip'))
tmpini       =  xbmc.translatePath(os.path.join('special://home/userdata',''))
ivuetarget   =  xbmc.translatePath(os.path.join('special://home/userdata/addon_data/script.ivueguide/resources/ini/plugin.video.no-sleep'))
def iVueInt():
	xbmc.executebuiltin("ActivateWindow(busydialog)")
	dp = xbmcgui.DialogProgress()
	dp.create("no-sleep","Copying ini",'', 'Please Wait')
	...
	iVueSet = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.no-sleep/resources/ivue','ivuesettings.xml'))
	iVueFold = xbmc.translatePath(os.path.join('special://home/addons/plugin.video.no-sleep/resources/ivue'))
	...
	dp = xbmcgui.DialogProgress()
	dp.create("no-sleep","Copying DB",'', 'Please Wait')
